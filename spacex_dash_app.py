...
def get_pie_chart(entered_site):
    if entered_site == "All":
        fig = px.pie(
            spacex_df, 
            names=spacex_df['class'].map({1: 'Success', 0: 'Failure'}),
            color = 'class',
            color_discrete_map={1:'cyan', 0: 'darkorange'},
...
@app.callback(Output(component_id = 'success-payload-scatter-chart', component_property = 'figure'),
              [Input(component_id = 'site_dropdown', component_property = 'value'), Input(component_id = 'payload-slider', component_property = 'value')])
